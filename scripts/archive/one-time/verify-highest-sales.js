...
// Verify that highest sales from API match what's in the database and leaderboard
...
// Get highest sale from API for a city
...
async function main() {
  ...
  writeFileSync(reportFile, JSON.stringify({ report, summary, issues }, null, 2));
  console.log(`\n💾 Full report exported to ${reportFile}`);
  
  // Exit with appropriate code
  process.exit(summary.mismatchCount > 0 ? 1 : 0);
}
